...
void Gabumon::Damage(float damage)
{
...
int Gabumon::AttackUsed(int RoundsPassed)
{
	int Atk = 0;
...
bool Gabumon::Dodge(int EnemySpeed)
{
	random_device rd; // obtain a random number from hardware
	mt19937 gen(rd()); // seed the generator
...
void Gabumon::Deleted()
{
	cout << Info.Name << " Was Deleted!!!" << endl;
}

void Gabumon::Digivolve()
{

}

void Gabumon::UseCard()
{
